...
DllExport int ccadical_vars (CCaDiCaL *);
DllExport int ccadical_declare_more_variables (CCaDiCaL *, int number_of_vars);
DllExport int ccadical_declare_one_more_variable (CCaDiCaL *);
